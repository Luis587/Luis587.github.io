...
function efectoHabilidades(){
    ...
    if(distancia_skills >= 300){
        ...
        habilidades[2].classList.add("nodered");
        habilidades[3].classList.add("arduino");
        habilidades[4].classList.add("fusion");
        habilidades[5].classList.add("mysql");
        habilidades[6].classList.add("aws");
        habilidades[7].classList.add("tia");
        habilidades[8].classList.add("blender");
        habilidades[9].classList.add("kicad");
